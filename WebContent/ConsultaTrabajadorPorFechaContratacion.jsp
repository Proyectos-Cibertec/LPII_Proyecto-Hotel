...
<%@taglib uri="http://java.sun.com/jstl/core_rt" prefix="c"%>
    ...
    <body>
        ...
        <div class="container">
            <h1>Consulta de Trabajadores por Fecha de Contratación</h1>
            <div class="col-md-23">
                <form accept-charset="UTF-8" action="trabajador" class="simple_form" id="frmFiltra" method="post">
                    <input type="hidden" name="metodo" value="consultaXFechaContratacion">
