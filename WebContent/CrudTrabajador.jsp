    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="col-md-23">
                ...
                <form id="idFormElimina" action="trabajador">
                    <input type="hidden" name="metodo" value="elimina">
                    <input type="hidden" id="id_elimina" name="idTrabajador">
                </form>

                <form accept-charset="UTF-8" action="trabajador" class="simple_form" id="defaultForm2" method="post">
                    ...
                    <div class="row primeraFila">
                        ...
                        <div class="col-md-3">
                            <button type="button" data-toggle='modal' onclick="mostrarModalRegistrar();" class='btn btn-primary btn-nuevo' id="">
                            	<span class="glyphicon glyphicon-plus-sign"></span> NUEVO TRABAJADOR
                            </button>
                            <br>&nbsp;<br>
                        </div>
                    </div>                    
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type='button' data-toggle='modal' class=' btn btn-success btn-actualizar' 
                                                    	onclick="mostrarModalEditar('${x.id}','${x.nombres}','${x.apellidos}','${x.dni}','${x.direccion}','${x.telefono}','${x.fechaNacimiento}','${x.fechaContratacion}', '${x.salario}');"> <img class="btn-image-icon" src='images/edit.png' />
												</button>
                                                </td>
                                                <!-- Eliminar -->
                                                <td>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formRegistrar" accept-charset="UTF-8" action="trabajador" class="form-horizontal" method="post">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#steps" href="#panelRegistrar">Datos del Trabajador</a>
                                            </h4>
                                        </div>
                                        <div id="panelRegistrar" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label" for="id_fechaContratacion">Fecha de Contratación</label>
                                                    <div class="col-lg-6">
                                                        <input class="form-control changeValidate" id="id_fechaContratacion" name="fechaContratacion" type="date" data-bv-trigger="change keyup" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label" for="id_salario">Salario</label>
                                                    <div class="col-lg-6">
                                                        <input class="form-control changeValidate" id="id_salario" name="salario" type="text" data-bv-trigger="change keyup" />
                                                    </div>
                                                </div>
            ...
            <div class="modal fade" id="modalActualizar">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="formActualizar" accept-charset="UTF-8" action="trabajador" class="form-horizontal" method="post">
                                ...
                                <div class="panel-group" id="steps">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h4 class="panel-title">
                                                <a data-toggle="collapse" data-parent="#steps" href="#panelActualizarDatos">Actualizar datos del trabajador</a>
                                            </h4>
                                        </div>
                                        <div id="panelActualizarDatos" class="panel-collapse collapse in">
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label" for="id_idTrabajador_actualiza">ID</label>
                                                    <div class="col-lg-6">
                                                        <input class="form-control changeValidate" id="id_idTrabajador_actualiza" readonly="readonly" name="idTrabajador" type="text" maxlength="8" />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label" for="id_fechaContratacion_actualiza">Fecha de Contratacion</label>
                                                    <div class="col-lg-6">
                                                        <input class="form-control changeValidate" id="id_fechaContratacion_actualiza" name="fechaContratacion" type="date" data-bv-trigger="change keyup" />
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label class="col-lg-3 control-label" for="id_salario_actualiza">Salario</label>
                                                    <div class="col-lg-6">
                                                        <input class="form-control changeValidate" id="id_salario_actualiza" name="salario" type="text" data-bv-trigger="change keyup" />
                                                    </div>
                                                </div>
        ...
        <script type="text/javascript">
            ...
            function limpiarEntradas() {
                ...
                $("#id_fechaContratacion").val(fechaHoy);
                $("#id_salario").val("");
            ...
            function mostrarModalRegistrar() {
                ...
                $("#id_fechaContratacion").val(fechaHoy);
                $("#id_fechaContratacion").change();
            }

            function mostrarModalEditar(idTrabajador, nombres, apellidos, dni, direccion, telefono, fechaNacimiento, fechaContratacion, salario) {
                $('input[id=id_idTrabajador_actualiza]').val(idTrabajador); // val = nombre de la variable del Servelet
                ...
                $('input[id=id_fechaContratacion_actualiza]').val(fechaContratacion);
                $('input[id=id_salario_actualiza]').val(salario);
                $(".changeValidate").change();
            ...
            function eliminar(idTrabajador) {
                ...
                swal({
                    title: 'Está seguro que desea eliminar al trabajador?',
                    ...
                    if (result.value) {
                    	$('input[id=id_elimina]').val(idTrabajador);
            ...
            $(document).ready(function() {
                ...
                $("#btnBuscarPersona").on("click", function() {
                    ...
                    $.getJSON("trabajador", {
                        ...
                        function(data, textStatus, jqXHR) {
                            console.log(data);
                            if (data.length > 0) {
                                // La persona ya está registrada como trabajador, no permitir que se registre nuevamente  
                                swal("El trabajador con número de DNI: " + dni + " ya se encuentra registrado en la tabla de Trabajadores. " +
                                ...
                                // La persona no está registrada como trabajador, pero se podría tratar de un cliente
                                ...
                                $.getJSON("persona", {
                                    ...
                                    function(data, textStatus, jqXHR) {
                                        console.log(data);
                                        if (data.length > 0) {
                                            swal("La persona con número de DNI: " + dni + " ya se encuentra registrado en la base de datos pero aún no está en la tabla de Trabajadores." +
                                                "Si desea registrarlo llene los campos faltantes y pulse en el botón Registrar.");
                ...
                $('#formActualizar, #formRegistrar').bootstrapValidator({
                    ...
                    fields: {
                        ...
                        fechaContratacion: {
                            message: 'El campo fecha de contratación no es válido',
                            validators: {
                                notEmpty: {
                        ...
                        salario: {
                            message: 'El campo salario no es válido',
                            validators: {
                                notEmpty: {
